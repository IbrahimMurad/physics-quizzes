...
def exam_create(request):
    ...
    scope_ids_string = request.POST.get("scope_ids", "")
    
    if scope_ids_string:
        # Remove duplicates and empty strings, then convert to list
        scope_ids = list(filter(None, set(scope_ids_string.split(","))))
    else:
        scope_ids = []
